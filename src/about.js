export default function () {
  ...
  const aboutTag = document.querySelector(`nav button[data-tag-name='about']`);
  aboutTag.classList.add('checked');

  const aboutDiv = document.createElement('div');
  aboutDiv.id = 'about';
  aboutDiv.innerHTML = `
    <h1>Welcome To Captain Toad's Café, About Page.</h1>
      <div class="card-container">
        <div class="card">
          ...
          <p class="p-large p-right">so817ch, wang_zifen9@outlook.com</p>
        </div>
        <div class="card">
